...
if exists (select 1 from sysobjects where name = 'SelectOneByCursistNummer_LesDavinci' AND type = 'P') -- P = procedure

begin
	drop proc SelectOneByCursistNummer_LesDavinci
end
go

create procedure SelectOneByCursistNummer_LesDavinci
(
	@CursistNummer int
)
